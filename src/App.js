...
class App extends Component {
  state = {
    ...
    language: "pl",
    ListPl: [
      { id: 0, path: "/copernicus_college/copernicus_college/o-nas", name: "O nas" },
      { id: 1, path: "/copernicus_college/copernicus_college/kursy/lista", name: "Kursy" },
      { id: 2, path: "/copernicus_college/copernicus_college/wyklady/lista", name: "Wykłady" },
      { id: 3, path: "/copernicus_college/copernicus_college/abc/lista", name: "ABC" },
      {
        id: 4,
        path: "/copernicus_college/copernicus_college/podreczniki/lista",
        name: "Podręczniki",
      },
      {
        id: 5,
        path: "/copernicus_college/copernicus_college/wykladowcy/lista",
        name: "Wykładowcy",
      },
      { id: 6, path: "/copernicus_college/copernicus_college/kategorie/lista", name: "Kategorie" },
    ],
    ListEn: [
      { id: 0, path: "/copernicus_college/copernicus_college/o-nas", name: "About us" },
      { id: 1, path: "/copernicus_college/copernicus_college/kursy/lista", name: "Courses" },
      { id: 2, path: "/copernicus_college/copernicus_college/wyklady/lista", name: "Lectures" },
      { id: 3, path: "/copernicus_college/copernicus_college/abc/lista", name: "ABC" },
      {
        id: 4,
        path: "/copernicus_college/copernicus_college/podreczniki/lista",
      ...
      { id: 6, path: "/copernicus_college/copernicus_college/kategorie/lista", name: "Categories" },
    ],
    homeRecomended: [
      {
        id: 0,
